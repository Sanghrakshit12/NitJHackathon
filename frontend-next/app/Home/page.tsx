...
import { fetchCoins } from "./cryptoservecvie";
    ...
    <div className="py-8 px-10">
      ...
      <section>
        <div className="flex items-center justify-between">
          ...
          <Link className="text-indigo-400 hover:text-indigo-500 hover:scale-105" href="/cryptos">
      ...
      <section>
        <div className="flex items-center justify-between">
          ...
          <Link className="text-indigo-400 hover:text-indigo-500 hover:scale-105" href="/news">
